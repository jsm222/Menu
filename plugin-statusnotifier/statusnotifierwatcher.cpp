...
StatusNotifierWatcher::StatusNotifierWatcher(QObject *parent) : QObject(parent)
{
    ...
    case QDBusConnectionInterface::ServiceNotRegistered:
        qWarning()
                << "StatusNotifier: unable to register service for org.kde.StatusNotifierWatcher";
        break;
    case QDBusConnectionInterface::ServiceQueued:
        qWarning() << "StatusNotifier: registration of service org.kde.StatusNotifierWatcher "
                      "queued, we can become primary after existing one deregisters";
        break;
